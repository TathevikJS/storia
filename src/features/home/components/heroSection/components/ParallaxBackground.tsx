  ...
  return (
    <View style={styles.container}>
      ...
      <Animated.Image
        ...
        style={[styles.layer, styles.z2, castleStyle]}
        resizeMode="cover"
      />
      {/* z1 — Dragon: strong parallax */}
      <Animated.Image
        source={IMAGES.dragon}
        style={[styles.layer, styles.z1, dragonStyle]}
        resizeMode="cover"
      />
      {/* z1 — Moon: gentle parallax */}
      <Animated.Image
        source={IMAGES.moon}
        style={[styles.layer, styles.z1, moonStyle]}
        resizeMode="cover"
      />
      ...
      <Animated.Image
        ...
        style={[styles.layer, styles.z4, styles.character]}
        resizeMode="cover"
      />
    </View>
  );
